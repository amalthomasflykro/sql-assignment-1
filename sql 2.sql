...
designation varchar(50),department_id int,location_id int,salary decimal(10.2));
desc departments;
desc employees;
desc location;
...
FROM employees WHERE YEAR(hire_date) = 2018
ORDER BY hire_date ASC
LIMIT 5;
SELECT SUM(salary) AS Total_Salary_Finance FROM employees
...
FROM employees WHERE gender = 'F' GROUP BY location_id HAVING AVG(age) < 30;
